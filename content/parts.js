...
/**
 * Creates the Core Concepts screen for the MLTEACH application
 * @function createCoreConcepts
 * @description Displays the 3 core concepts of gradient descent
 * @returns {void}
 */
function createCoreConcepts() {
...
/**
 * Creates the Prerequisites screen for the MLTEACH application
 * @function createPrerequisites
 * @description Displays what users need to know before starting
 * @returns {void}
 */
function createPrerequisites() {
    const levelId = 'prerequisites';
    const container = document.getElementById('app');
    container.innerHTML = `
        <div class="current-level">
            <div class="level-content celebration" style="padding: 30px;">
